  ...
  <body>
    ...
    <!-- <div class="container-xxl">
        <div class="about-menu">
          <img src="assets/img/achievement-home-2048x343.jpg" />
        </div>
    </div> -->
    <div class="conainer-xxl">
      <div class="home-menu">
        <img src="<?= base_url() ?>assets/img/achievement-home-2048x343.jpg" />
      </div>
    </div>
    <div class="achievement-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <div class="achievement-img">
                        <img src="<?= base_url() ?>assets/img/achiev.png">
                    </div>
                </div>

                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="achievement-middle">
                        <h2 class="achieve-title">Best Educational Institute in Korattur</h2>
                        <p class="achieve-desc">The main purpose of building the institute was to develop a pleasant atmosphere in guiding the students for their future visions. We have produced great results not only from commendable student but also from an average once.<br><br>
                          The methodologies we use in teaching have generated trust among the students and parents, they all believe and consider Ghurudev Institutions as a primary educational institute for quality education. All our teachers update themselves according to the changes and the requirements of the Indian Curriculum.<br><br>
                          We ensure that students succeed in their examinations, as well as encouraging them to improve their skills, attitudes, and inspiring them to develop new talents through our education.
                        </p>
                    </div>
                </div>
            ...
            <div class="our-achieve">
              <h2 class="our-Atitle">Our Achievements</h2>
              <p class="our-Adesc"><i class="bookreader fas fa-book-reader"></i>Classes are structured to help students not just learn concepts but also practice and revise them.</p>
              <p class="our-Adesc">
                <i class="bookreader fas fa-book-reader"></i>Every class is carefully designed by experts with methods that are proven to give results.</p>
              <p class="our-Adesc"><i class="bookreader fas fa-book-reader"></i>The expert teacher explains and teachers topics in-depth ensuring.</p>
            </div>
            <div class="carousel">
            <div class="wrapper">
              <button class="prev" type="button" onclick="prevSlide(this)"><i class="fa fa-angle-left"></i></button>
              <div class="slider">
                <div class="item">
                  <img src="<?= base_url() ?>assets/img/vishnu-189x190-1-150x150.jpg" />
                  <div class="title">Vishnu (483 / 500)</div>
                </div>
        
                <div class="item">
                  <img src="<?= base_url() ?>assets/img/santho-7-150x150.jpg" />
                  <div class="info">
                    <div class="title">Santhosini (483 / 500)</div>
                  </div>
                </div>
        
                <div class="item">
                  <img src="<?= base_url() ?>assets/img/swathi-1.jpg" />
                  <div class="title">Swathi (490 / 500)</div>
                </div>
        
                <div class="item">
                  <img  src="<?= base_url() ?>assets/img/abihsa.png" />
                  <div class="title">Abisha (460 / 500)</div>
                </div>
        
                <div class="item">
                  <img src="<?= base_url() ?>assets/img/david.png" />
                  <div class="title">David (462 / 500)</div>
                </div>
              </div>
              <button class="next" type="button" onclick="nextSlide(this)"><i class="fa fa-angle-right" aria-hidden="true"></i></button>
            </div>
            </div>
            <div class="reach-out">
                <a href="tel=+91 8220725879">
                  <button class="btn btn-reach">Reach Us</button>
                </a>
            </div>
        </div>
    </div>
