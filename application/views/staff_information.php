  ...
  <div class="profile-nav col-md-3">
      <div class="panel">
          <div class="user-heading round">
              <a href="#">
                  <img  src="<?= base_url('upload/staff_upload/' . $staff_data[0]->staff_pic) ?>" alt="" width="100" height="100">
              </a>
              <h1><?= $staff_data[0]->staff_fname ?>  <?= $staff_data[0]->staff_lname ?></h1>
              <p>Staff Id : <?= $staff_data[0]->staff_id ?></p>
  ...
  <div class="profile-info col-md-9">
      ...
      <div class="panel">
          ...
          <div class="panel-body bio-graph-info">
              ...
              <div class="row staff_details">
                  <div class="bio-row">
                      <p><span>Staff Id  </span> : <?= $staff_data[0]->staff_id ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Name </span>: <?= $staff_data[0]->staff_fname ?>  <?= $staff_data[0]->staff_lname ?> </p>
                  </div>
                  <div class="bio-row">
                      <p><span>Date Of Birth </span>: <?= $staff_data[0]->staff_dob ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Age </span>: <?= $staff_data[0]->staff_age ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Gender </span>: <?= $staff_data[0]->staff_gender ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Subject </span>: <?= $staff_data[0]->staff_subject ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Date of Join </span>: <?= $staff_data[0]->staff_doj ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Mobile Number </span>: <?= $staff_data[0]->staff_number ?> </p>
                  </div>
                  <div class="bio-row">
                      <p><span>Mail </span>: <?= $staff_data[0]->staff_email ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Address </span>: <?= $staff_data[0]->staff_address ?></p>
                  </div>
              </div>
          </div>
