        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form action="<?=base_url('main/std_validate')?>" method="POST" class="needs-validation" novalidate="">
                  <div class="form-group">
                    <label for="adminid">Enroll Number</label>
                    <input id="adminid" type="text" class="form-control" name="stdroll" tabindex="1" required autofocus>
                  ...
                  <div class="form-group">
                    ...
                    <input id="date" type="date" class="form-control" name="stddob" tabindex="2" required>
                    <div class="invalid-feedback">
