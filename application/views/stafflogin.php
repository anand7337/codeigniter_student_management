        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form action="<?=base_url('main/staff_validate')?>" method="POST" class="needs-validation" novalidate="">
                  <div class="form-group">
                    <label for="adminid">Enter Staff ID</label>
                    <input id="adminid" type="text" class="form-control" name="staff_id" tabindex="1" required autofocus>
                    <div class="invalid-feedback">
                     please fill your staff ID Number
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="date" class="control-label">Enter Your Date of Birth</label>
                    <input id="date" type="date" class="form-control" name="staff_dob" tabindex="2" required>
                    <div class="invalid-feedback">
