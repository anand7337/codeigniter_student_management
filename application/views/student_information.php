          ...
          <ul class="menu-item">
            ...
            if ($user = $this->session->userdata('std_user')) {
              ...
              <li class="menu-list menu-lists">
                <a href="#" class="menu-link">Student Profile</a>
                <ul class="sub_menu_item">
                  <li class="sub_menu_list">
                    <a href="<?= base_url('main/stdlogin') ?>" class="sub_menu_link">Welcome : <?= $std_name ?></a>
                  </li>
                  <li class="sub_menu_list">
                    <a href="<?= base_url('main/std_information/') . $id ?>" class="sub_menu_link">Student Details</a>
                  </li>
                  <li class="sub_menu_list">
  ...
  <div class="profile-nav col-md-3">
      <div class="panel">
          <div class="user-heading round">
              <a href="#">
                  <img  src="<?= base_url('upload/' . $data7[0]->std_pic) ?>" alt="" width="100" height="100">
              </a>
              <h1><?= $data7[0]->std_name ?></h1>
              <p>Enroll Number : <?= $data7[0]->std_enroll ?></p>
              <p>Standard :  <?= $data7[0]->std_standard ?> </p>
          </div>
  ...
  <div class="profile-info col-md-9">
      ...
      <div class="panel">
          ...
          <div class="panel-body bio-graph-info">
              ...
              <div class="row">
                  <div class="bio-row">
                      <p><span>Enroll Number  </span> : <?= $data7[0]->std_enroll ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Name </span>: <?= $data7[0]->std_name ?> </p>
                  </div>
                  <div class="bio-row">
                      <p><span>Birthday </span>: <?= $data7[0]->std_dob ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Gender </span>: <?= $data7[0]->std_gender ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Father </span>: <?= $data7[0]->std_parent ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Standard </span>: <?= $data7[0]->std_standard ?> </p>
                  </div>
                  <div class="bio-row">
                      <p><span>Date of Join </span>: <?= $data7[0]->std_doj ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Mobile Number </span>: <?= $data7[0]->std_mobile ?> </p>
                  </div>
                  <div class="bio-row">
                      <p><span>Mail </span>: <?= $data7[0]->std_mail ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Address </span>: <?= $data7[0]->std_address ?></p>
                  </div>
              </div>
          </div>
          <hr>
          ...
          <div class="panel-body bio-graph-info">
              ...
              <div class="row">
                  <div class="bio-row1">
                      <p><span>Total Fees Paid </span>:<?= $data14[0]->std_paid_amnt ?></p>
                  </div>
                  <div class="bio-row1">
                      <p><span>Pending Amount To Be Pay </span>:<?= $data14[0]->std_pending_amnt ?></p>
                  </div>
                  <div class="bio-row1">
                      <p><span>Payment Status </span>:<?= $data14[0]->std_amnt_status ?></p>
                  </div>      
                  <div class="payment">
              <div class="bio-row1">
              <p><span class="click"> Click </span> : <a href="<?= base_url('main/std_payment_page') ?>" class="effect-underline"> Online Payment Method</a></p>
                  </div>
                  </div>         
              </div>
