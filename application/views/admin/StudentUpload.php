        ...
        <section class="section">
          <div class="section-body">
            <div class="row">
              ...
              <div class="card">
                <form action="<?= base_url('main/student_form') ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="text" name="std_enroll" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="text" name="std_parent" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Student's School Name :</label>
                      <input type="text" name="std_school" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="date" class="form-control" name="std_doj">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Mobile Number(Home) :</label>
                      <input type="text" class="form-control" name="std_mobile">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Student Email :</label>
                      <input type="email" class="form-control" name="std_mail">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="file" class="form-control" name="std_pic">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
