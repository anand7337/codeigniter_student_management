...
<head>
  ...
  <title>Student Details Upload Form</title>
  <!-- General CSS Files -->
        ...
        <section class="section">
          <div class="section-body">
            <div class="row">
              ...
              <div class="card">
                <form action="<?= base_url('main/kids_form') ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="text" name="kids_enroll" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="date" name="kids_dob" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Age :</label>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Gender :</label>
                      <select class="form-control" name="kids_gender">
                        <option>-- -- --</option>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="text" name="kids_parent" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Student's School Name :</label>
                      <input type="text" name="kids_school" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="date" class="form-control" name="kids_doj">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Mobile Number(Home) :</label>
                      <input type="text" class="form-control" name="kids_mobile">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Student Email :</label>
                      <input type="email" class="form-control" name="kids_mail">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Student's Address :</label>
                      <input type="text" class="form-control" name="kids_address">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Student Profile Photo :</label>
                      <input type="file" class="form-control" name="kids_pic">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
