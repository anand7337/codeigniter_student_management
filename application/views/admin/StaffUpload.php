...
<head>
  ...
  <title>Staff's Details Upload Form</title>
  <!-- General CSS Files -->
        ...
        <section class="section">
          <div class="section-body">
            <div class="row">
              ...
              <div class="card">
                <form action="<?= base_url('main/staff_form')?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="staffid" name="staff_id" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>First Name :</label>
                      <input type="fname" name="staff_fname" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Last Name :</label>
                      <input type="lname" name="staff_lname" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Age :</label>
                      <input type="age" name="staff_age" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Sex :</label>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="date" name="staff_doj" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Mobile Number :</label>
                      <input type="mobile" name="staff_number" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      ...
                      <input type="address" name="staff_address" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Staff's Profile Photo :</label>
                      <input type="file" name="staff_pic" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
