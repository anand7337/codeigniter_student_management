          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?= base_url('main/Six_std')  ?>">6th</a></li>
                <li><a class="nav-link" href="<?= base_url('main/Seven_std')  ?>">7th</a></li>
                <li><a class="nav-link" href="<?= base_url('main/Eight_std')  ?>">8th</a></li>
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?= $row->std_name  ?> <?= $row->std_lname  ?></td>
                            <td><?= $row->std_dob  ?></td>
