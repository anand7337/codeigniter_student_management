                          ...
                          <?php
                             if(isset($data11)){
                              foreach($data11 as $row){
                                  ?>
                          <tr>
                            <td><?= $row->kids_enroll?></td>        
                            <td><img src="<?= base_url('upload/kids_upload/' .$row->kids_pic) ?>" alt="" width="100"></td>               
                            <td><?= $row->kids_name  ?></td>
                            <td><?= $row->kids_dob  ?></td>
                            <td><?= $row->kids_parent  ?></td>
                            <td><?= $row->kids_standard ?></td>
                            <td><?= $row->kids_mobile  ?></td>
                            <td><a href="<?= base_url('main/kids_data/') .$row->id?>" class="btn btn-primary">View Detail</a></td>
                            <td><a href="<?= base_url('main/kids_edit/') .$row->id?>" class="btn btn-primary">Edit</a></td>
                            <td><a href="<?= base_url('main/kids_delete/') .$row->id?>" class="btn btn-primary">Delete</a></td>
                          </tr>
                          <?php
                              }
                            }
