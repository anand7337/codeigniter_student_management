...
<head>
  ...
  <title>Kids Fees Details Upload Form</title>
  <!-- General CSS Files -->
        ...
        <section class="section">
          <div class="section-body">
            <div class="row">
              ...
              <div class="card">
                <form action="<?= base_url('main/kids_fees_upload') ?>" method="post" enctype="multipart/form-data">

                  <div class="card-header">
                    <h4>Kid's Fees Details Upload Form</h4>
                  </div>
                  <div class="card-body">
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Enter EnRoll Number :</label>
                      <input type="text" name="kid_check_enroll" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Fill Total Amount Paid :</label>
                      <input type="text" name="kid_amnt_paid" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Fill Pending Amount To be Pay:</label>
                      <input type="text" name="kid_pending_amnt" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                      <label>Fees Status:</label>
                      <select class="form-control" name="kid_fees_status">
                        <option>-- -- -- </option>
