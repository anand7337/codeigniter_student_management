                  ...
                  <div class="card author-box">
                    <div class="card-body">
                      <div class="author-box-center">
                        <img alt="image" src="<?= base_url('upload/' . $data7[0]->std_pic) ?>" width="100" height="100"
                        ...
                        <div class="author-box-job">Roll Number :
                          <?= $data7[0]->std_enroll ?>
                        </div>
                      </div>
