                    ...
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?= $row->staff_id?></td>        
                            <td><img src="<?= base_url('upload/staff_upload/' .$row->staff_pic) ?>" alt="" width="100"></td>               
                            <td><?= $row->staff_fname  ?> <?= $row->staff_lname  ?></td>
                            <td><?= $row->staff_gender  ?></td>
                            <td><?= $row->staff_subject  ?></td>
                            <td><?= $row->staff_doj ?></td>
                            <td><?= $row->staff_number  ?></td>
                            <td><a href="<?= base_url('main/staff_data/') .$row->id?>" class="btn btn-primary">View Detail</a></td>
                            <td><a href="<?= base_url('main/staff_edit/') .$row->id?>" class="btn btn-primary">Edit</a></td>
                            <td><a href="<?= base_url('main/staff_delete/') .$row->id?>" class="btn btn-primary">Delete</a></td>
                          </tr>
                          <?php
                              }
                            }
